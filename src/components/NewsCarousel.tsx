        ...
        >
            ...
            {items.length > 1 && (
                ...
                <button
                    onClick={() => goTo(activeIndex + 1)}
                    aria-label="Next"
                    className="hidden sm:flex absolute -right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white shadow-md border border-[var(--color-sage-line)] items-center justify-center
                    text-[var(--color-forest)] hover:bg-[var(--color-paper-warm)] z-10"
                    >
